...
export class BffController {
  ...
  async updateProfile(
    @Headers('Authorization') authHeader: string,
    @Body() updateProfileDto: any, // Use 'any' for now, can create a DTO later
  ) {
  ...
  async addAddress(
    @Headers('Authorization') authHeader: string,
    @Body() addAddressDto: any, // Use 'any' for now, can create a DTO later
  ) {
  ...
  async updateAddress(
    ...
    @Body() updateAddressDto: any, // Use 'any' for now, can create a DTO later
  ) {
